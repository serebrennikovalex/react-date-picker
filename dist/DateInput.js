...
var DateInput = /*#__PURE__*/function (_PureComponent) {
  ...
  function DateInput() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderDay", function (currentMatch, index) {
      ...
      var hasLeadingZeros = showLeadingZeros && !(_this.dayInput && _this.dayInput.value && _this.dayInput.value.length > 1 && _this.dayInput.value[0] === '0');
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMonth", function (currentMatch, index) {
      ...
      var showLeadingZerosFromFormat = currentMatch && currentMatch.length === 2;
      var hasLeadingZeros = showLeadingZeros && !(_this.monthInput && _this.monthInput.value && _this.monthInput.value.length > 1 && _this.monthInput.value[0] === '0');
